...
//	String url = "jdbc:oracle:thin:@localhost:1521:XE";
	...
	private static final String INSERT_STMT =
			"INSERT INTO HEALTHDETAIL (HEALTHNO, NEWSTITLE, NEWSINTRO, EMP_NO, COVERPIC, STATUS) VALUES (to_char('HD'||LPAD(to_char(HEALTHNO_SEQ.NEXTVAL),4,'0')),? ,?, ?, ?, ?)";
	// 查全部
	...
	private static final String UPDATE = 
			"UPDATE NEWSDETAIL SET NEWSTITLE=?, NEWSINTRO=?, EMP_NO=?, COVERPIC=?, NEWSDATE=CURRENT_TIMESTAMP , STATUS=? where HEALTHNO = ?";
...
//		healthNewsDetailVO1.setEmp_no("EMP0005");
...
//		healthNewsDetailVO2.setHealthNo("ND0059");
...
//		
		...
		// 查單筆
//		HealthNewsDetailVO healthNewsDetailVO3 = dao.findByPrimaryKey("HD0008");
