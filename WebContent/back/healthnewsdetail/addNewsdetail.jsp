...
<title>保健資料新增 - addNews.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>保健資料新增 - addNews.jsp</h3></td><td>
...
<table>
	<tr>
		<td>文章標題:</td>
		<td><input type="TEXT" name="newsTitle" size="45" value="${healthNewsDetailVO.newsTitle == null ? '' : healthNewsDetailVO.newsTitle}"/></td>
	</tr>
	<tr>
		<td>文章內容:</td>
		<td>
		<textarea rows="5" cols="45" name="newsIntro" size="45"/>${healthNewsDetailVO.newsIntro== null ? '' :healthNewsDetailVO.newsIntro}</textarea></td>
	</tr>
	<tr>
		<td>員工編號:</td>
		<td><input name="emp_no" id="emp_no" type="text" value="EMP0010"></td>
	</tr>
