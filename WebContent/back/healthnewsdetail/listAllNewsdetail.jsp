...
<table>
	...
	<c:forEach var="healthNewsDetailVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		 <tr align='center' valign='middle' ${(healthNewsDetailVO.healthNo == param.healthNo) ? 'bgcolor=#FFD1A4':''}>
		<tr>
			...
			<td><img height=100 src="<%=request.getContextPath()%>/HealthDBGifReader4.do?healthNo=${healthNewsDetailVO.healthNo}"></td>
