...
<%
  NewsdetailVO newsdetailVO = (NewsdetailVO) request.getAttribute("newsdetailVO"); //NewsdetailServlet.java(Concroller), 存入req的VO物件
%>
...
<table>
	...
	<tr>
		...
		<td><img src="<%=request.getContextPath()%>/newsdetail/newsimgread.do?newsno=${newsdetailVO.newsno}" style= max-width:150px;max-height:150px;></img></td>
