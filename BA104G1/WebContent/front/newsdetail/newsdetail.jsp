...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-12">
					<img alt="Bootstrap Image Preview" src="<%=request.getContextPath()%>/newsdetail/newsimgread.do?newsno=${newsdetailVO.newsno}" class="img-thumbnail center-block img-responsive imgbig" />
					<div class="page-header">
						<h1>
							${newsdetailVO.newstitle}</h1>
							<small>${sdf.format(newsdetailVO.newsdate)}</small>
					</div>
					<p class="lead text-muted text-left">${newsdetailVO.newsintro}</p> 
					<a class="button btn-sm" style="vertical-align:middle" href="<%=request.getContextPath()%>/front/newsdetail/allnews.jsp" >回最新資訊</a>
