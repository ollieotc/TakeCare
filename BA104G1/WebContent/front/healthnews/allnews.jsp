...
<%@ include file="/front/healthnews/page1.file" %> 
        ...
        <div class="row">
             <div class="col-md-12">
                 <div class="row hidden-md hidden-lg">
                  <h1 class="text-center" >${healthNewsDetailVO.newsTitle}</h1></div>
                     
                  <div class="pull-left col-md-4 col-xs-12 thumb-contenido">
                  <img class="center-block img-responsive" src="<%=request.getContextPath()%>/healthnewsdetail/healthimgread.do?healthNo=${healthNewsDetailVO.healthNo}" /></div>
               
                  <div class="">
                     <h1  class="hidden-xs hidden-sm">${healthNewsDetailVO.newsTitle}</h1>
                     <small>${sdf.format(healthNewsDetailVO.newsDate)}</small>
                     <hr>
                     <p class="text-justify">${healthNewsDetailVO.newsIntro}</p>
                     <br>
                     <!-- Button readmore -->
...
<%@ include file="/front/healthnews/page2.file" %>
